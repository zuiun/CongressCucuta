...
Congress of Cúcuta is built as a standalone executable, but uses [.NET 9.0](https://dotnet.microsoft.com/en-us/download/dotnet/9.0/runtime).
...
Simón Bolívar has just liberated Quito from Spanish rule, one of his first steps towards his most ambitious dream: a continent-spanning federation, centred around the nascent state of Colombia.
...
A clique of leading officers has taken power, promising to ward away the Peronist spectre and revive the faltering economy.
...
Meanwhile, the Quiet Revolution in Quebec laid the roots for the ongoing outpouring of Quebecer nationalism, and the two nations of Canada find themselves at cross purposes.
